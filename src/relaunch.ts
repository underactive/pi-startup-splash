...
// ---------------------------------------------------------------------------
// Startup gate: a blocking menu shown during session_start before the editor
// becomes usable. Resume relaunches pi in-place with adjusted CLI flags;
// New/Quit resolve the gate directly.
// ---------------------------------------------------------------------------

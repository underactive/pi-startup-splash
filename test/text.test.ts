...
describe("fitCell (T-09, T-15)", () => {
	...
	it.todo("FINDING F-2 (T-15): width below the ellipsis overflows the requested width", () => {
		// fitCell always emits the full 3-col ellipsis, exceeding width < 3. Unreachable
		// from current callers; kept as a todo per the report-don't-reconcile protocol.
		const text = "abcdef";

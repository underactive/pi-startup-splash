...
describe("TwoPaneModelThinking (M-07..M-12)", () => {
	...
	it.todo("FINDING F-6: the footer's button row overflows very narrow bodies", () => {
		// The Select/Cancel row has a ~26-column natural minimum and is not truncated below
		// it. Kept as a todo per the report-don't-reconcile protocol (W invariant).
		const picker = makePicker();
